...
import admin1.ufm.quanlybanhangfahasa.Fragment_Fahasa.Fragment_CapNhat;
...
public class ViewPagerAdapterFahasa extends FragmentStateAdapter {

    private String maTK;
    public ViewPagerAdapterFahasa(@NonNull FragmentActivity fragmentActivity, String maTK) {
    ...
    public Fragment createFragment(int position) {
        switch (position){
            case 0:{
                Fragment_CapNhat f_capNhat = new Fragment_CapNhat();
                Bundle bundle = new Bundle();
                bundle.putString("maTK",maTK);
                f_capNhat.setArguments(bundle);
                return f_capNhat;
            }
            case 1:{
