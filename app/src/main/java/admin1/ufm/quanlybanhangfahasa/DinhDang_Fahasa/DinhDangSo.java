package admin1.ufm.quanlybanhangfahasa.DinhDang_Fahasa;
...
public class DinhDangSo implements TextWatcher {
    ...
    public DinhDangSo(EditText editText, Locale locale, int numDecimals) {
...
//        String ngayHienTai = day+"/"+month+"/"+ year;
//        this.editText.setText(ngayHienTai);
